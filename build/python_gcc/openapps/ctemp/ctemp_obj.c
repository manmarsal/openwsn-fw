...
This was done on 2017-04-24 20:52:09.590138.
*/
/**
...
const uint8_t ctemp_path0[]       = "l";

//=========================== prototypes ======================================

owerror_t ctemp_receive(OpenMote* self, 
   OpenQueueEntry_t* msg,
   coap_header_iht*  coap_header,
   coap_option_iht*  coap_options
);
void ctemp_sendDone(OpenMote* self, 
   OpenQueueEntry_t* msg,
   owerror_t error
);
...
void ctemp_init(OpenMote* self) {
 /*
   ...
   cleds_vars.desc.path0len            = sizeof(ctemp_path0)-1;
   cleds_vars.desc.path0val            = (uint8_t*)(&ctemp_path0);
   ...
   cleds_vars.desc.callbackRx          = &ctemp_receive;
   cleds_vars.desc.callbackSendDone    = &ctemp_sendDone;
...
*/
void ctemp_sendDone(OpenMote* self, OpenQueueEntry_t* msg, owerror_t error) {
